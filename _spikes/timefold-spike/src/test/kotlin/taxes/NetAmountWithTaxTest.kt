...
class NetAmountWithTaxTest {
  ...
  fun `calculate tax for 0`() {
    val amount = NetAmountWithTax(NetAmount(10.toBigDecimal())).apply {
      taxRate = TaxRate.PCT_00
    }
  ...
  fun `calculate tax for 19`() {
    val amount = NetAmountWithTax(NetAmount(100.toBigDecimal())).apply {
      taxRate = TaxRate.PCT_19
    }
